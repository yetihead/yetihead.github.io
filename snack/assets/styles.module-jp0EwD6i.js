import{j as e}from"./jsx-runtime-BTJTZTIL.js";import{S as l}from"./Sun-CLMO8Tpr.js";import{I as h,A as b,a as m,C as g}from"./index-C-NxZ9RO.js";const f=`# Change Log
...
* [@snack-uikit/link@0.17.7](https://github.com/cloud-ru-tech/snack-uikit/blob/master/packages/link/CHANGELOG.md)
...
* [@snack-uikit/link@0.17.5](https://github.com/cloud-ru-tech/snack-uikit/blob/master/packages/link/CHANGELOG.md)
...
* [@snack-uikit/link@0.17.4](https://github.com/cloud-ru-tech/snack-uikit/blob/master/packages/link/CHANGELOG.md)
...
### Only dependencies have been changed
* [@snack-uikit/link@0.17.3](https://github.com/cloud-ru-tech/snack-uikit/blob/master/packages/link/CHANGELOG.md)
...
* [@snack-uikit/link@0.17.2](https://github.com/cloud-ru-tech/snack-uikit/blob/master/packages/link/CHANGELOG.md)
...
- [@snack-uikit/link@0.17.1](https://github.com/cloud-ru-tech/snack-uikit/blob/master/packages/link/CHANGELOG.md)
...
- [@snack-uikit/link@0.17.0](https://github.com/cloud-ru-tech/snack-uikit/blob/master/packages/link/CHANGELOG.md)
...
- [@snack-uikit/link@0.16.5](https://github.com/cloud-ru-tech/snack-uikit/blob/master/packages/link/CHANGELOG.md)
...
- [@snack-uikit/link@0.16.4](https://github.com/cloud-ru-tech/snack-uikit/blob/master/packages/link/CHANGELOG.md)
...
- [@snack-uikit/link@0.16.3](https://github.com/cloud-ru-tech/snack-uikit/blob/master/packages/link/CHANGELOG.md)
...
- [@snack-uikit/link@0.16.2](https://github.com/cloud-ru-tech/snack-uikit/blob/master/packages/link/CHANGELOG.md)
...
- [@snack-uikit/link@0.16.1](https://github.com/cloud-ru-tech/snack-uikit/blob/master/packages/link/CHANGELOG.md)
...
- [@snack-uikit/link@0.15.13](https://github.com/cloud-ru-tech/snack-uikit/blob/master/packages/link/CHANGELOG.md)
...
- [@snack-uikit/link@0.15.12](https://github.com/cloud-ru-tech/snack-uikit/blob/master/packages/link/CHANGELOG.md)
...
- [@snack-uikit/link@0.15.11](https://github.com/cloud-ru-tech/snack-uikit/blob/master/packages/link/CHANGELOG.md)
...
- [@snack-uikit/link@0.15.9](https://github.com/cloud-ru-tech/snack-uikit/blob/master/packages/link/CHANGELOG.md)
...
- [@snack-uikit/link@0.15.8](https://github.com/cloud-ru-tech/snack-uikit/blob/master/packages/link/CHANGELOG.md)
...
- [@snack-uikit/link@0.15.7](https://github.com/cloud-ru-tech/snack-uikit/blob/master/packages/link/CHANGELOG.md)
...
- [@snack-uikit/link@0.15.6](https://github.com/cloud-ru-tech/snack-uikit/blob/master/packages/link/CHANGELOG.md)
...
- [@snack-uikit/link@0.15.5](https://github.com/cloud-ru-tech/snack-uikit/blob/master/packages/link/CHANGELOG.md)
...
- [@snack-uikit/link@0.15.4](https://github.com/cloud-ru-tech/snack-uikit/blob/master/packages/link/CHANGELOG.md)
...
- [@snack-uikit/link@0.15.3](https://github.com/cloud-ru-tech/snack-uikit/blob/master/packages/link/CHANGELOG.md)
...
- [@snack-uikit/link@0.15.2](https://github.com/cloud-ru-tech/snack-uikit/blob/master/packages/link/CHANGELOG.md)
...
- [@snack-uikit/link@0.13.4](https://github.com/cloud-ru-tech/snack-uikit/blob/master/packages/link/CHANGELOG.md)
...
- [@snack-uikit/link@0.13.3](https://github.com/cloud-ru-tech/snack-uikit/blob/master/packages/link/CHANGELOG.md)
...
- [@snack-uikit/link@0.13.1](https://github.com/cloud-ru-tech/snack-uikit/blob/master/packages/link/CHANGELOG.md)
...
- [@snack-uikit/link@0.12.4](https://github.com/cloud-ru-tech/snack-uikit/blob/master/packages/link/CHANGELOG.md)
...
- [@snack-uikit/link@0.12.3](https://github.com/cloud-ru-tech/snack-uikit/blob/master/packages/link/CHANGELOG.md)
...
- [@snack-uikit/link@0.12.2](https://github.com/cloud-ru-tech/snack-uikit/blob/master/packages/link/CHANGELOG.md)
...
- [@snack-uikit/link@0.12.1](https://github.com/cloud-ru-tech/snack-uikit/blob/master/packages/link/CHANGELOG.md)
...
- [@snack-uikit/link@0.12.0](https://github.com/cloud-ru-tech/snack-uikit/blob/master/packages/link/CHANGELOG.md)
...
- [@snack-uikit/link@0.11.10](https://github.com/cloud-ru-tech/snack-uikit/blob/master/packages/link/CHANGELOG.md)
...
- [@snack-uikit/link@0.11.9](https://github.com/cloud-ru-tech/snack-uikit/blob/master/packages/link/CHANGELOG.md)
...
- [@snack-uikit/link@0.11.8](https://github.com/cloud-ru-tech/snack-uikit/blob/master/packages/link/CHANGELOG.md)
...
- [@snack-uikit/link@0.11.5](https://github.com/cloud-ru-tech/snack-uikit/blob/master/packages/link/CHANGELOG.md)
...
- [@snack-uikit/link@0.11.4](https://github.com/cloud-ru-tech/snack-uikit/blob/master/packages/link/CHANGELOG.md)
...
- [@snack-uikit/link@0.11.3](https://github.com/cloud-ru-tech/snack-uikit/blob/master/packages/link/CHANGELOG.md)
- [@snack-uikit/truncate-string@0.4.9](https://github.com/cloud-ru-tech/snack-uikit/blob/master/packages/truncate-string/CHANGELOG.md)
...
- [@snack-uikit/link@0.11.0](https://github.com/cloud-ru-tech/snack-uikit/blob/master/packages/link/CHANGELOG.md)

## 0.8.2 (2024-02-01)

### Only dependencies have been changed

- [@snack-uikit/link@0.10.2](https://github.com/cloud-ru-tech/snack-uikit/blob/master/packages/link/CHANGELOG.md)
...
- [@snack-uikit/link@0.9.3](https://github.com/cloud-ru-tech/snack-uikit/blob/master/packages/link/CHANGELOG.md)
...
- [@snack-uikit/link@0.9.2](https://github.com/cloud-ru-tech/snack-uikit/blob/master/packages/link/CHANGELOG.md)
...
- [@snack-uikit/link@0.9.1](https://github.com/cloud-ru-tech/snack-uikit/blob/master/packages/link/CHANGELOG.md)
...
- [@snack-uikit/link@0.8.1](https://github.com/cloud-ru-tech/snack-uikit/blob/master/packages/link/CHANGELOG.md)
...
- [@snack-uikit/icons@0.16.0](https://github.com/cloud-ru-tech/snack-uikit/blob/master/packages/icons/CHANGELOG.md)
- [@snack-uikit/link@0.5.5](https://github.com/cloud-ru-tech/snack-uikit/blob/master/packages/link/CHANGELOG.md)
- [@snack-uikit/truncate-string@0.2.6](https://github.com/cloud-ru-tech/snack-uikit/blob/master/packages/truncate-string/CHANGELOG.md)
...
- [@snack-uikit/link@0.5.3](https://github.com/cloud-ru-tech/snack-uikit/blob/master/packages/link/CHANGELOG.md)
...
- [@snack-uikit/link@0.5.2](https://github.com/cloud-ru-tech/snack-uikit/blob/master/packages/link/CHANGELOG.md)
...
- [@snack-uikit/link@0.5.1](https://github.com/cloud-ru-tech/snack-uikit/blob/master/packages/link/CHANGELOG.md)
...
- [@snack-uikit/link@0.4.4](https://github.com/cloud-ru-tech/snack-uikit/blob/master/packages/link/CHANGELOG.md)
...
- [@snack-uikit/link@0.4.1](https://github.com/cloud-ru-tech/snack-uikit/blob/master/packages/link/CHANGELOG.md)
...
- Initial version
`,p="@snack-uikit/alert",G="0.16.15",v={name:p,version:G},y=`# Alert
...
`,n={Neutral:"neutral",Primary:"primary",Error:"error",Warning:"warning",Success:"success",Info:"info"},F={[n.Neutral]:"neutral",[n.Primary]:"primary",[n.Error]:"red",[n.Warning]:"yellow",[n.Success]:"green",[n.Info]:"blue"},x={[n.Neutral]:"primary",[n.Primary]:"primary",[n.Error]:"red",[n.Warning]:"yellow",[n.Success]:"green",[n.Info]:"blue"},O="_alertButton_1rf36_1",A="_text_1rf36_13",E="_icon_1rf36_29",i={alertButton:O,text:A,icon:E};function k({appearance:c,text:t,icon:a,onClick:o,variant:r="simple",dataTestId:d,loading:s=!1,size:u="s"}){return e.jsxs("button",{type:"button",onClick:o,className:i.alertButton,"data-variant":r,"data-appearance":c,"data-test-id":d||"alert__action-button","data-icon-only":!t||void 0,"data-loading":s,"data-size":u,children:[t&&e.jsx("span",{className:i.text,"data-size":u,children:t}),a&&(s?e.jsx(l,{size:"s"}):e.jsx("span",{className:i.icon,children:a}))]})}try{k.displayName="AlertButton",k.__docgenInfo={description:"",displayName:"AlertButton",props:{appearance:{defaultValue:null,description:"Внешний вид",name:"appearance",required:!1,type:{name:"enum",value:[{value:'"neutral"'},{value:'"primary"'},{value:'"red"'},{value:'"orange"'},{value:'"yellow"'},{value:'"green"'},{value:'"blue"'},{value:'"violet"'},{value:'"pink"'},{value:'"invert-neutral"'}]}},text:{defaultValue:null,description:"Текст кнопки",name:"text",required:!1,type:{name:"string"}},icon:{defaultValue:null,description:"Иконка в кнопке",name:"icon",required:!1,type:{name:"ReactElement<any, string | JSXElementConstructor<any>>"}},variant:{defaultValue:{value:"simple"},description:"Вариант отображения",name:"variant",required:!1,type:{name:"enum",value:[{value:'"simple"'},{value:'"tonal"'}]}},onClick:{defaultValue:null,description:"Колбек клика",name:"onClick",required:!1,type:{name:"((e: MouseEvent<HTMLButtonElement, MouseEvent>) => void)"}},dataTestId:{defaultValue:null,description:"Дата тест айди",name:"dataTestId",required:!1,type:{name:"string"}},loading:{defaultValue:{value:"false"},description:"Управление состоянием загрузки",name:"loading",required:!1,type:{name:"boolean"}},size:{defaultValue:{value:"s"},description:"Размер",name:"size",required:!1,type:{name:"enum",value:[{value:'"s"'},{value:'"m"'}]}}}}}catch{}function _(c,t){switch(c){case n.Success:return e.jsx(g,{size:t});case n.Error:return e.jsx(m,{size:t});case n.Warning:return e.jsx(b,{size:t});case n.Primary:case n.Neutral:default:return e.jsx(h,{size:t})}}const N="_wrapper_4wy6n_1",B={wrapper:N};export{F as A,n as a,x as b,k as c,v as d,y as e,f,_ as g,B as s};
