import{j as e}from"./jsx-runtime-BTJTZTIL.js";import{P as r,C as f,A as l}from"./PromoTag-CBgpLGjS.js";import{P as b}from"./index-C9_U387z.js";import"./index-ChsGqxH_.js";import"./index-DUmpqB7p.js";import"./_commonjsHelpers-D6-XlEtG.js";import"./Typography-DmSN6cv6.js";import"./index-CJ_LmFaV.js";import"./componentPropsProcessors-UJEZy8aQ.js";const C=`# Change Log
...
- [@snack-uikit/typography@0.8.5](https://github.com/cloud-ru-tech/snack-uikit/blob/master/packages/typography/CHANGELOG.md)
...
- [@snack-uikit/typography@0.5.1](https://github.com/cloud-ru-tech/snack-uikit/blob/master/packages/typography/CHANGELOG.md)
...
- Initial version
`,G="@snack-uikit/promo-tag",O="0.7.6",u={name:G,version:O},N='# Promo Tag\n\n## Installation\n`npm i @snack-uikit/promo-tag`\n\n[Changelog](./CHANGELOG.md)\n\n\n\n[//]: DOCUMENTATION_SECTION_START\n[//]: THIS_SECTION_IS_AUTOGENERATED_PLEASE_DONT_EDIT_IT\n## PromoTag\nКомпонент Promo Tag\n### Props\n| name | type | default value | description |\n|------|------|---------------|-------------|\n| text | `string` | - | Текст компонента |\n| appearance | enum Appearance: `"neutral"`, `"primary"`, `"red"`, `"orange"`, `"yellow"`, `"green"`, `"blue"`, `"violet"`, `"pink"` | primary | Внешний вид |\n| color | enum Color: `"accent"`, `"decor"` | accent | Семантический цвет |\n| className | `string` | - | CSS-класс |\n| onClick | `(e: MouseEvent<HTMLDivElement, MouseEvent>) => void` | - | Колбэк для обработки клика на тег |\n| size | "xxs" \\| "xs" \\| "s" | xxs | Размер |\n| beforeContent | `ReactNode` | - | Контент перед текстом |\n| afterContent | `ReactNode` | - | Контент после текста |\n\n\n[//]: DOCUMENTATION_SECTION_END\n',A="_story_fmepa_1",d={story:A},k=e.jsx(b,{"data-test-id":"before-node",size:24}),g=e.jsx(b,{"data-test-id":"after-node",size:24}),I={title:"Components/Promo Tag",component:r},y=()=>alert("clicked"),E=({showText:t,showBefore:a,showAfter:c,clickable:o,...n})=>e.jsx("table",{children:Object.values(l).map(s=>e.jsxs("tr",{children:[e.jsxs("td",{children:[s,":"]}),e.jsx("td",{children:e.jsx(r,{...n,text:t?n.text:void 0,size:n.size,beforeContent:a?k:void 0,afterContent:c?g:void 0,appearance:s,onClick:o?y:void 0})})]},s))}),v=({showText:t,showBefore:a,showAfter:c,clickable:o,...n})=>e.jsxs(e.Fragment,{children:[e.jsx("div",{children:e.jsx("div",{className:d.story,children:e.jsx("table",{children:e.jsxs("tr",{children:[e.jsx("td",{children:"controlled:"}),e.jsx("td",{children:e.jsx(r,{...n,text:t?n.text:void 0,size:n.size,beforeContent:a?k:void 0,afterContent:c?g:void 0,onClick:o?y:void 0})})]})})})}),e.jsx("div",{className:d.story,children:E({showText:t,showBefore:a,showAfter:c,clickable:o,...n})})]}),i={render:v,args:{text:"Promo Tag",showText:!0,showBefore:!0,showAfter:!0,clickable:!1,appearance:l.Neutral,color:f.Accent,size:"xxs"},argTypes:{showText:{name:"[Story]: Show text node",type:"boolean"},showBefore:{name:"[Story]: Show beforeContent node",type:"boolean"},showAfter:{name:"[Story]: Show afterContent node",type:"boolean"},clickable:{name:"[Story]: Show behavior tag with onClick",type:"boolean"},onClick:{table:{disable:!0}},beforeContent:{table:{disable:!0}},afterContent:{table:{disable:!0}}},parameters:{readme:{sidebar:[`Latest version: ${u.version}`,N,C]},packageName:u.name,design:{name:"Figma",type:"figma",url:"https://www.figma.com/file/jtGxAPvFJOMir7V0eQFukN/Snack-UI-Kit-1.1.0?node-id=41%3A27190&mode=design"}}};var h,p,m;i.parameters={...i.parameters,docs:{...(h=i.parameters)==null?void 0:h.docs,source:{originalSource:`{
  render: Template,
  args: {
    text: 'Promo Tag',
    showText: true,
...
}`,...(m=(p=i.parameters)==null?void 0:p.docs)==null?void 0:m.source}}};export{I as default,i as promoTag};
